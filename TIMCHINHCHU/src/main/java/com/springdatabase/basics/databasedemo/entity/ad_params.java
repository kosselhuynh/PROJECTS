...
public class ad_params {
	...
	public ad_params(Parameter address, Parameter area, Parameter landed_type, Parameter region, Parameter rooms,
	...
	public String toString() {
		return "ad_params {address=" + address + ", area=" + area + ", landed_type=" + landed_type + ", region="
				+ region + ", rooms=" + rooms + ", size=" + size + ", ward=" + ward + "}";
	}
